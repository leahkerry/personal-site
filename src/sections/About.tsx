...
return (
<section id="about" className="container pt-24 pb-2">
<h2>About</h2>
<p className="mt-3 text-slate-700">I’m a senior at Tufts University studying Computer Science and Art. I make 3D graphics projects and build tools that bridge art and software.</p>
